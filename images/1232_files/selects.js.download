...
function StationSelect(input, container, options) {
  ...
  return StationDistrictSelect(fields, input, container, extend(options, {
    placeholder: options.placeholder ? options.placeholder : getLang('select_station_not_selected'), obj: obj, value: options.station}));
}
...
function CitySelect(input, container, options) {
  ...
  function updateChildren(new_value) {
    ...
    if (opts.stationSelectWithColor) {
      opts.stationSelectWithColor.setOptions({city: new_value});
    }
  }
